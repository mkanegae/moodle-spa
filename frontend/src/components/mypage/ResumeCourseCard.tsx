    ...
    <Card className="border-0 shadow-none">
      <CardContent className="p-4 sm:p-6">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-sm sm:text-base font-bold text-gray-700" style={{ fontFamily: 'Noto Sans JP, sans-serif' }}>
            学習を開始する
          </h3>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[minmax(300px,400px)_1fr] gap-4 sm:gap-6">
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center text-center p-3">
              <h4 className="text-lg sm:text-xl lg:text-2xl font-bold text-white drop-shadow-lg" style={{ fontFamily: 'Noto Sans JP, sans-serif' }}>
                {course.title}
              </h4>
            </div>
          </div>

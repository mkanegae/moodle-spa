...
class WebCoachUserProfileUpdate(BaseModel):
    ...
    ideal_work_style: Optional[str] = Field(default=None, max_length=256, description="理想の働き方")
    monthly_goal: Optional[str] = Field(default=None, max_length=256, description="今月の目標")
